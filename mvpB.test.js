...
describe('Sprint 7 Challenge Learner Tests', () => {
  ...
  */
    ...
    describe('sum function tests', () => {
      test('throws an error when called with no arguments', () => {
        expect(() => sum()).toThrow('pass valid numbers');
      });
    
      test('throws an error when a non-numeric string is passed', () => {
      ...
      test('returns the correct sum when one argument is a numeric string', () => {
        expect(sum('1', 2)).toBe(3);
      });
    
      test('returns the correct sum when both arguments are numeric strings', () => {
  ...
  */
    ...
    describe('HelloWorld component tests', () => {
      ...
      test('renders a text that includes "javaScript is pretty" (case-insensitive)', () => {
        expect(
          screen.queryByText('javaScript is pretty', { exact: false })
        ).toBeInTheDocument();
      });
    });
